...
Route::group(['prefix' => 'administracion', 'as' => 'administracion.', 'namespace' => 'Administracion', 'middleware' => ['auth']], function () {
    Route::redirect('/', '/login')->name('home');
    // Permissions
    Route::delete('dependencias/destroy', 'DependenciasController@massDestroy')->name('dependencias.massDestroy');
